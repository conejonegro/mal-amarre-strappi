...
export interface ApiObraObra extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::obra.obra', 'titulo'> & Attribute.Required;
    imagen: Attribute.Media & Attribute.Required;
    relacion_obra: Attribute.Relation<
      'api::obra.obra',
      'oneToMany',
      'api::tecnica.tecnica'
    >;
...
export interface ApiPedidoPedido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    addressShiping: Attribute.JSON & Attribute.Required;
...
export interface ApiTecnicaTecnica extends Schema.CollectionType {
  ...
  attributes: {
    titulo: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::tecnica.tecnica', 'titulo'> & Attribute.Required;
    descripcion: Attribute.Text & Attribute.Required;
    order: Attribute.Integer & Attribute.Required;
    tecnica_logo: Attribute.Media & Attribute.Required;
    obra: Attribute.Relation<
      'api::tecnica.tecnica',
      'manyToOne',
      'api::obra.obra'
    >;
...
export interface ApiWhislistWhislist extends Schema.CollectionType {
